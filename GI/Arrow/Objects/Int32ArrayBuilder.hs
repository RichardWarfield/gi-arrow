...
-- ** Overloaded methods #method:Overloaded methods#
    ...
    ResolveInt32ArrayBuilderMethod          ,
#endif
...
#if defined(ENABLE_OVERLOADING)
    Int32ArrayBuilderAppendValueMethodInfo  ,
#endif
    int32ArrayBuilderAppendValue            ,
...
instance GObject Int32ArrayBuilder where
    gobjectType = c_garrow_int32_array_builder_get_type
    

-- | Convert 'Int32ArrayBuilder' to and from 'Data.GI.Base.GValue.GValue' with 'Data.GI.Base.GValue.toGValue' and 'Data.GI.Base.GValue.fromGValue'.
instance B.GValue.IsGValue Int32ArrayBuilder where
    toGValue o = do
        gtype <- c_garrow_int32_array_builder_get_type
        B.ManagedPtr.withManagedPtr o (B.GValue.buildGValue gtype B.GValue.set_object)
        
    fromGValue gv = do
        ptr <- B.GValue.get_object gv :: IO (Ptr Int32ArrayBuilder)
        B.ManagedPtr.newObject Int32ArrayBuilder ptr
        
    

-- | Type class for types which can be safely cast to `Int32ArrayBuilder`, for instance with `toInt32ArrayBuilder`.
class (GObject o, O.IsDescendantOf Int32ArrayBuilder o) => IsInt32ArrayBuilder o
instance (GObject o, O.IsDescendantOf Int32ArrayBuilder o) => IsInt32ArrayBuilder o

instance O.HasParentTypes Int32ArrayBuilder
type instance O.ParentTypes Int32ArrayBuilder = '[Arrow.ArrayBuilder.ArrayBuilder, GObject.Object.Object]
...
type family ResolveInt32ArrayBuilderMethod (t :: Symbol) (o :: *) :: * where
    ...
    ResolveInt32ArrayBuilderMethod "appendValue" o = Int32ArrayBuilderAppendValueMethodInfo
    ...
    ResolveInt32ArrayBuilderMethod "setDataFull" o = GObject.Object.ObjectSetDataFullMethodInfo
...
instance (info ~ ResolveInt32ArrayBuilderMethod t Int32ArrayBuilder, O.MethodInfo info Int32ArrayBuilder p) => OL.IsLabel t (Int32ArrayBuilder -> p) where
...
-- returnType: Just
--               (TInterface
--                  Name { namespace = "Arrow" , name = "Int32ArrayBuilder" })
-- throws : False
-- Skip return : False
...
int32ArrayBuilderNew ::
    ...
    m Int32ArrayBuilder
    -- ^ __Returns:__ A newly created t'GI.Arrow.Objects.Int32ArrayBuilder.Int32ArrayBuilder'.
...
--           , argDoc =
--               Documentation
--                 { rawDocText = Just "A #GArrowInt32ArrayBuilder."
...
--           , argDoc =
--               Documentation
--                 { rawDocText = Just "A int32 value." , sinceVersion = Nothing }
--           , argScope = ScopeTypeInvalid
--           , argClosure = -1
--           , argDestroy = -1
--           , argCallerAllocates = False
...
{-# DEPRECATED int32ArrayBuilderAppend ["(Since version 0.12.0)","","  Use 'GI.Arrow.Objects.Int32ArrayBuilder.int32ArrayBuilderAppendValue' instead."] #-}
-- | /No description available in the introspection data./
int32ArrayBuilderAppend ::
    (B.CallStack.HasCallStack, MonadIO m, IsInt32ArrayBuilder a) =>
    a
    -- ^ /@builder@/: A t'GI.Arrow.Objects.Int32ArrayBuilder.Int32ArrayBuilder'.
    -> Int32
    -- ^ /@value@/: A int32 value.
    -> m ()
...
instance (signature ~ (Int32 -> m ()), MonadIO m, IsInt32ArrayBuilder a) => O.MethodInfo Int32ArrayBuilderAppendMethodInfo a signature where
    overloadedMethod = int32ArrayBuilderAppend
...
instance (signature ~ (m ()), MonadIO m, IsInt32ArrayBuilder a) => O.MethodInfo Int32ArrayBuilderAppendNullMethodInfo a signature where
    overloadedMethod = int32ArrayBuilderAppendNull
...
instance (signature ~ (Int64 -> m ()), MonadIO m, IsInt32ArrayBuilder a) => O.MethodInfo Int32ArrayBuilderAppendNullsMethodInfo a signature where
    overloadedMethod = int32ArrayBuilderAppendNulls

#endif

-- method Int32ArrayBuilder::append_value
-- method type : OrdinaryMethod
-- Args: [ Arg
--           { argCName = "builder"
--           , argType =
...
foreign import ccall "garrow_int32_array_builder_append_value" garrow_int32_array_builder_append_value :: 
    Ptr Int32ArrayBuilder ->                -- builder : TInterface (Name {namespace = "Arrow", name = "Int32ArrayBuilder"})
    Int32 ->                                -- value : TBasicType TInt32
    Ptr (Ptr GError) ->                     -- error
    IO CInt
...
int32ArrayBuilderAppendValue ::
    ...
    -> m ()
    -- ^ /(Can throw 'Data.GI.Base.GError.GError')/
int32ArrayBuilderAppendValue builder value = liftIO $ do
    builder' <- unsafeManagedPtrCastPtr builder
    onException (do
        _ <- propagateGError $ garrow_int32_array_builder_append_value builder' value
        touchManagedPtr builder
        return ()
     ) (do
        return ()
...
instance (signature ~ (Int32 -> m ()), MonadIO m, IsInt32ArrayBuilder a) => O.MethodInfo Int32ArrayBuilderAppendValueMethodInfo a signature where
    overloadedMethod = int32ArrayBuilderAppendValue
...
--           , argDoc =
--               Documentation
--                 { rawDocText = Just "The array of int32."
--                 , sinceVersion = Nothing
--                 }
--           , argScope = ScopeTypeInvalid
--           , argClosure = -1
...
instance (signature ~ ([Int32] -> Maybe ([Bool]) -> m ()), MonadIO m, IsInt32ArrayBuilder a) => O.MethodInfo Int32ArrayBuilderAppendValuesMethodInfo a signature where
    overloadedMethod = int32ArrayBuilderAppendValues
