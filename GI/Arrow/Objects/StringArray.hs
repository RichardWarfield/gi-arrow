...
instance GObject StringArray where
    gobjectType = c_garrow_string_array_get_type
    

-- | Convert 'StringArray' to and from 'Data.GI.Base.GValue.GValue' with 'Data.GI.Base.GValue.toGValue' and 'Data.GI.Base.GValue.fromGValue'.
instance B.GValue.IsGValue StringArray where
    toGValue o = do
        gtype <- c_garrow_string_array_get_type
        B.ManagedPtr.withManagedPtr o (B.GValue.buildGValue gtype B.GValue.set_object)
        
    fromGValue gv = do
        ptr <- B.GValue.get_object gv :: IO (Ptr StringArray)
        B.ManagedPtr.newObject StringArray ptr
        
    

-- | Type class for types which can be safely cast to `StringArray`, for instance with `toStringArray`.
class (GObject o, O.IsDescendantOf StringArray o) => IsStringArray o
instance (GObject o, O.IsDescendantOf StringArray o) => IsStringArray o
...
instance (info ~ ResolveStringArrayMethod t StringArray, O.MethodInfo info StringArray p) => OL.IsLabel t (StringArray -> p) where
