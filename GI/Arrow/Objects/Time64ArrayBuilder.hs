...
instance GObject Time64ArrayBuilder where
    gobjectType = c_garrow_time64_array_builder_get_type
    

-- | Convert 'Time64ArrayBuilder' to and from 'Data.GI.Base.GValue.GValue' with 'Data.GI.Base.GValue.toGValue' and 'Data.GI.Base.GValue.fromGValue'.
instance B.GValue.IsGValue Time64ArrayBuilder where
    toGValue o = do
        gtype <- c_garrow_time64_array_builder_get_type
        B.ManagedPtr.withManagedPtr o (B.GValue.buildGValue gtype B.GValue.set_object)
        
    fromGValue gv = do
        ptr <- B.GValue.get_object gv :: IO (Ptr Time64ArrayBuilder)
        B.ManagedPtr.newObject Time64ArrayBuilder ptr
...
instance (info ~ ResolveTime64ArrayBuilderMethod t Time64ArrayBuilder, O.MethodInfo info Time64ArrayBuilder p) => OL.IsLabel t (Time64ArrayBuilder -> p) where
...
instance (signature ~ (m ()), MonadIO m, IsTime64ArrayBuilder a) => O.MethodInfo Time64ArrayBuilderAppendNullMethodInfo a signature where
    overloadedMethod = time64ArrayBuilderAppendNull
...
instance (signature ~ (Int64 -> m ()), MonadIO m, IsTime64ArrayBuilder a) => O.MethodInfo Time64ArrayBuilderAppendNullsMethodInfo a signature where
    overloadedMethod = time64ArrayBuilderAppendNulls
...
instance (signature ~ (Int64 -> m ()), MonadIO m, IsTime64ArrayBuilder a) => O.MethodInfo Time64ArrayBuilderAppendValueMethodInfo a signature where
