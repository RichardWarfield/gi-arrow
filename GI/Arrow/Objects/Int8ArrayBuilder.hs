...
instance GObject Int8ArrayBuilder where
    gobjectType = c_garrow_int8_array_builder_get_type
    

-- | Convert 'Int8ArrayBuilder' to and from 'Data.GI.Base.GValue.GValue' with 'Data.GI.Base.GValue.toGValue' and 'Data.GI.Base.GValue.fromGValue'.
instance B.GValue.IsGValue Int8ArrayBuilder where
    toGValue o = do
        gtype <- c_garrow_int8_array_builder_get_type
        B.ManagedPtr.withManagedPtr o (B.GValue.buildGValue gtype B.GValue.set_object)
        
    fromGValue gv = do
        ptr <- B.GValue.get_object gv :: IO (Ptr Int8ArrayBuilder)
        B.ManagedPtr.newObject Int8ArrayBuilder ptr
...
instance (info ~ ResolveInt8ArrayBuilderMethod t Int8ArrayBuilder, O.MethodInfo info Int8ArrayBuilder p) => OL.IsLabel t (Int8ArrayBuilder -> p) where
...
instance (signature ~ (m ()), MonadIO m, IsInt8ArrayBuilder a) => O.MethodInfo Int8ArrayBuilderAppendNullMethodInfo a signature where
    overloadedMethod = int8ArrayBuilderAppendNull
...
instance (signature ~ (Int64 -> m ()), MonadIO m, IsInt8ArrayBuilder a) => O.MethodInfo Int8ArrayBuilderAppendNullsMethodInfo a signature where
    overloadedMethod = int8ArrayBuilderAppendNulls
...
instance (signature ~ (Int8 -> m ()), MonadIO m, IsInt8ArrayBuilder a) => O.MethodInfo Int8ArrayBuilderAppendValueMethodInfo a signature where
