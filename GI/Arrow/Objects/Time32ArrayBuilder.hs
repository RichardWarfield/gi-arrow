...
instance GObject Time32ArrayBuilder where
    gobjectType = c_garrow_time32_array_builder_get_type
    

-- | Convert 'Time32ArrayBuilder' to and from 'Data.GI.Base.GValue.GValue' with 'Data.GI.Base.GValue.toGValue' and 'Data.GI.Base.GValue.fromGValue'.
instance B.GValue.IsGValue Time32ArrayBuilder where
    toGValue o = do
        gtype <- c_garrow_time32_array_builder_get_type
        B.ManagedPtr.withManagedPtr o (B.GValue.buildGValue gtype B.GValue.set_object)
        
    fromGValue gv = do
        ptr <- B.GValue.get_object gv :: IO (Ptr Time32ArrayBuilder)
        B.ManagedPtr.newObject Time32ArrayBuilder ptr
...
instance (info ~ ResolveTime32ArrayBuilderMethod t Time32ArrayBuilder, O.MethodInfo info Time32ArrayBuilder p) => OL.IsLabel t (Time32ArrayBuilder -> p) where
...
instance (signature ~ (m ()), MonadIO m, IsTime32ArrayBuilder a) => O.MethodInfo Time32ArrayBuilderAppendNullMethodInfo a signature where
    overloadedMethod = time32ArrayBuilderAppendNull
...
instance (signature ~ (Int64 -> m ()), MonadIO m, IsTime32ArrayBuilder a) => O.MethodInfo Time32ArrayBuilderAppendNullsMethodInfo a signature where
    overloadedMethod = time32ArrayBuilderAppendNulls
...
instance (signature ~ (Int32 -> m ()), MonadIO m, IsTime32ArrayBuilder a) => O.MethodInfo Time32ArrayBuilderAppendValueMethodInfo a signature where
