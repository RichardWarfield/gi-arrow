...
instance GObject UInt8ArrayBuilder where
    gobjectType = c_garrow_uint8_array_builder_get_type
    

-- | Convert 'UInt8ArrayBuilder' to and from 'Data.GI.Base.GValue.GValue' with 'Data.GI.Base.GValue.toGValue' and 'Data.GI.Base.GValue.fromGValue'.
instance B.GValue.IsGValue UInt8ArrayBuilder where
    toGValue o = do
        gtype <- c_garrow_uint8_array_builder_get_type
        B.ManagedPtr.withManagedPtr o (B.GValue.buildGValue gtype B.GValue.set_object)
        
    fromGValue gv = do
        ptr <- B.GValue.get_object gv :: IO (Ptr UInt8ArrayBuilder)
        B.ManagedPtr.newObject UInt8ArrayBuilder ptr
...
instance (info ~ ResolveUInt8ArrayBuilderMethod t UInt8ArrayBuilder, O.MethodInfo info UInt8ArrayBuilder p) => OL.IsLabel t (UInt8ArrayBuilder -> p) where
...
instance (signature ~ (m ()), MonadIO m, IsUInt8ArrayBuilder a) => O.MethodInfo UInt8ArrayBuilderAppendNullMethodInfo a signature where
    overloadedMethod = uInt8ArrayBuilderAppendNull
...
instance (signature ~ (Int64 -> m ()), MonadIO m, IsUInt8ArrayBuilder a) => O.MethodInfo UInt8ArrayBuilderAppendNullsMethodInfo a signature where
    overloadedMethod = uInt8ArrayBuilderAppendNulls
...
instance (signature ~ (Word8 -> m ()), MonadIO m, IsUInt8ArrayBuilder a) => O.MethodInfo UInt8ArrayBuilderAppendValueMethodInfo a signature where
