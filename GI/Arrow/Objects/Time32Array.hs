...
instance GObject Time32Array where
    gobjectType = c_garrow_time32_array_get_type
    

-- | Convert 'Time32Array' to and from 'Data.GI.Base.GValue.GValue' with 'Data.GI.Base.GValue.toGValue' and 'Data.GI.Base.GValue.fromGValue'.
instance B.GValue.IsGValue Time32Array where
    toGValue o = do
        gtype <- c_garrow_time32_array_get_type
        B.ManagedPtr.withManagedPtr o (B.GValue.buildGValue gtype B.GValue.set_object)
        
    fromGValue gv = do
        ptr <- B.GValue.get_object gv :: IO (Ptr Time32Array)
        B.ManagedPtr.newObject Time32Array ptr
        
    

-- | Type class for types which can be safely cast to `Time32Array`, for instance with `toTime32Array`.
class (GObject o, O.IsDescendantOf Time32Array o) => IsTime32Array o
instance (GObject o, O.IsDescendantOf Time32Array o) => IsTime32Array o
...
instance (info ~ ResolveTime32ArrayMethod t Time32Array, O.MethodInfo info Time32Array p) => OL.IsLabel t (Time32Array -> p) where
