...
instance GObject Time64Array where
    gobjectType = c_garrow_time64_array_get_type
    

-- | Convert 'Time64Array' to and from 'Data.GI.Base.GValue.GValue' with 'Data.GI.Base.GValue.toGValue' and 'Data.GI.Base.GValue.fromGValue'.
instance B.GValue.IsGValue Time64Array where
    toGValue o = do
        gtype <- c_garrow_time64_array_get_type
        B.ManagedPtr.withManagedPtr o (B.GValue.buildGValue gtype B.GValue.set_object)
        
    fromGValue gv = do
        ptr <- B.GValue.get_object gv :: IO (Ptr Time64Array)
        B.ManagedPtr.newObject Time64Array ptr
        
    

-- | Type class for types which can be safely cast to `Time64Array`, for instance with `toTime64Array`.
class (GObject o, O.IsDescendantOf Time64Array o) => IsTime64Array o
instance (GObject o, O.IsDescendantOf Time64Array o) => IsTime64Array o
...
instance (info ~ ResolveTime64ArrayMethod t Time64Array, O.MethodInfo info Time64Array p) => OL.IsLabel t (Time64Array -> p) where
