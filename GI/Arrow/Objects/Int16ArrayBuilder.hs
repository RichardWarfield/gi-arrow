...
instance GObject Int16ArrayBuilder where
    gobjectType = c_garrow_int16_array_builder_get_type
    

-- | Convert 'Int16ArrayBuilder' to and from 'Data.GI.Base.GValue.GValue' with 'Data.GI.Base.GValue.toGValue' and 'Data.GI.Base.GValue.fromGValue'.
instance B.GValue.IsGValue Int16ArrayBuilder where
    toGValue o = do
        gtype <- c_garrow_int16_array_builder_get_type
        B.ManagedPtr.withManagedPtr o (B.GValue.buildGValue gtype B.GValue.set_object)
        
    fromGValue gv = do
        ptr <- B.GValue.get_object gv :: IO (Ptr Int16ArrayBuilder)
        B.ManagedPtr.newObject Int16ArrayBuilder ptr
        
    

-- | Type class for types which can be safely cast to `Int16ArrayBuilder`, for instance with `toInt16ArrayBuilder`.
class (GObject o, O.IsDescendantOf Int16ArrayBuilder o) => IsInt16ArrayBuilder o
instance (GObject o, O.IsDescendantOf Int16ArrayBuilder o) => IsInt16ArrayBuilder o
...
instance (info ~ ResolveInt16ArrayBuilderMethod t Int16ArrayBuilder, O.MethodInfo info Int16ArrayBuilder p) => OL.IsLabel t (Int16ArrayBuilder -> p) where
...
instance (signature ~ (m ()), MonadIO m, IsInt16ArrayBuilder a) => O.MethodInfo Int16ArrayBuilderAppendNullMethodInfo a signature where
    overloadedMethod = int16ArrayBuilderAppendNull
...
instance (signature ~ (Int64 -> m ()), MonadIO m, IsInt16ArrayBuilder a) => O.MethodInfo Int16ArrayBuilderAppendNullsMethodInfo a signature where
    overloadedMethod = int16ArrayBuilderAppendNulls
...
instance (signature ~ (Int16 -> m ()), MonadIO m, IsInt16ArrayBuilder a) => O.MethodInfo Int16ArrayBuilderAppendValueMethodInfo a signature where
