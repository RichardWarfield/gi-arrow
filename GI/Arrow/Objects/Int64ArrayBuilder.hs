...
instance GObject Int64ArrayBuilder where
    gobjectType = c_garrow_int64_array_builder_get_type
    

-- | Convert 'Int64ArrayBuilder' to and from 'Data.GI.Base.GValue.GValue' with 'Data.GI.Base.GValue.toGValue' and 'Data.GI.Base.GValue.fromGValue'.
instance B.GValue.IsGValue Int64ArrayBuilder where
    toGValue o = do
        gtype <- c_garrow_int64_array_builder_get_type
        B.ManagedPtr.withManagedPtr o (B.GValue.buildGValue gtype B.GValue.set_object)
        
    fromGValue gv = do
        ptr <- B.GValue.get_object gv :: IO (Ptr Int64ArrayBuilder)
        B.ManagedPtr.newObject Int64ArrayBuilder ptr
...
instance (info ~ ResolveInt64ArrayBuilderMethod t Int64ArrayBuilder, O.MethodInfo info Int64ArrayBuilder p) => OL.IsLabel t (Int64ArrayBuilder -> p) where
...
instance (signature ~ (m ()), MonadIO m, IsInt64ArrayBuilder a) => O.MethodInfo Int64ArrayBuilderAppendNullMethodInfo a signature where
    overloadedMethod = int64ArrayBuilderAppendNull
...
instance (signature ~ (Int64 -> m ()), MonadIO m, IsInt64ArrayBuilder a) => O.MethodInfo Int64ArrayBuilderAppendNullsMethodInfo a signature where
    overloadedMethod = int64ArrayBuilderAppendNulls
...
instance (signature ~ (Int64 -> m ()), MonadIO m, IsInt64ArrayBuilder a) => O.MethodInfo Int64ArrayBuilderAppendValueMethodInfo a signature where
